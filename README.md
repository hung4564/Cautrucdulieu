...
- ### Linked Lists
    - [X] Miêu tả:
        - [ ] [Singly Linked Lists - Danh sách liên kết đơn](./docs/Linked%20list.md#single-linked-list)
	- [ ] [Doubly Linked Lists - Danh sách liên kết đôi](./docs/Linked%20list.md#doubly-linked-list)
    ...
    - [ ] Danh sách liên kết so sánh với Mảng:
    	- [ ] [So sánh](./docs/so%20sanh%20mang%20vs%20list.md)
